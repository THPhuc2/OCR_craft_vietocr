...
def recognize_structure(img, save_dir):
    ...
    print("Kết hợp đường dọc và ngang")
...
def create_mask_for_tables(img, boxes, min_width=120, min_height=120): #150
    """
